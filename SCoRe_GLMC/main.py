...
def main():
    ...
    args.store_name = '#'.join(["dataset: " + args.dataset, "arch: " + args.arch, "loss: ",args.loss_version, "imbanlance_rate: " + str(args.imbanlance_rate)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_version', type=str, default='simplified', help="simplified, original, FL, GC")
